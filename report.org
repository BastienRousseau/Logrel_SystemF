...
known as /progress/ and /preservation/
[cite:@pierceTypesProgrammingLanguages2002].
The former says that if an expression is well-typed, it is either a value, or it
can perform a step. The later says that if an expression is well-typed, the next
step will also be well-typed.
